                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-y border-gray-200 dark:border-gray-700">
                            ...
                            <th class="px-4 py-3 text-sm text-gray-500 text-left" @click="sortBy('harga_per_jam')" data-sort="harga_per_jam">
                                Harga
                            </th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        <template x-for="(item, index) in paginated" :key="item.id_lapangan">
                            <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02]">
                                ...
                                <td class="px-4 py-4 text-sm text-gray-500"
                                    x-text="'Rp ' + Number(item.harga_per_jam).toLocaleString('id-ID')">
                                </td>
