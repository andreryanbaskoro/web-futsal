<x-common.component-card title="Default Inputs">
    ...
    <form method="GET"
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-5 items-end">
            ...
            {{-- LAPANGAN (CUSTOM SELECT) --}}
            <div>
                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                    Lapangan
                </label>

                <div x-data="{ isOptionSelected: {{ request('lapangan') ? 'true' : 'false' }} }"
                    ...
                    <select
                        ...
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800
                           h-11 w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 pr-11
                           text-sm placeholder:text-gray-400 focus:ring-3 focus:outline-hidden
                        ...
                        <option value="{{ $lap->id }}"
                            {{ request('lapangan') == $lap->id ? 'selected' : '' }}
            ...
            <div class="flex gap-2">
                <button type="submit"
                    class="h-11 w-full rounded-lg bg-blue-500 px-4 text-sm font-medium text-white hover:bg-blue-600">
                    Filter
                </button>

                <a href="{{ route('owner.laporan.jadwal') }}"
                    class="h-11 w-full rounded-lg bg-gray-200 px-4 text-sm font-medium text-gray-700 hover:bg-gray-300 flex items-center justify-center">
                    Reset
                </a>
            </div>
            ...
            <div>
                <a href="{{ route('owner.laporan.jadwal.export', request()->all()) }}"
                    class="h-11 w-full rounded-lg bg-green-500 px-4 text-sm font-medium text-white hover:bg-green-600 flex items-center justify-center">
                    Export Excel
                </a>
            </div>
