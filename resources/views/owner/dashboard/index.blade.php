                        ...
                        <template x-for="transaction in paginatedTransactions" :key="transaction.id">
                            <tr>
                                ...
                                <td class="px-4 py-4 text-sm font-medium text-end whitespace-nowrap">
                                    <!-- Ubah dan Hapus tombol dengan Font Awesome Icons -->
                                    <div class="flex justify-end gap-3">
                                        <!-- Ubah tombol dengan ikon Font Awesome -->
                                        <button type="button" class="text-blue-500 hover:text-yellow-700">
                                            <i class="fas fa-edit"></i> <!-- Ikon Edit -->
                                        </button>
                                        <!-- Hapus tombol dengan ikon Font Awesome -->
