...
$user = Auth::user();
$avatar = '/images/user/default.png'; // ganti dengan kolom avatar jika ada

$menuItems = [
    ['text' => 'Edit Profile', 'path' => '#'],
    ['text' => 'Account Settings', 'path' => '#'],
    ['text' => 'Support', 'path' => '#'],
];
@endphp
...
<div class="relative" x-data="{
    ...
    >
        ...
        <span class="block mr-1 font-medium text-theme-sm">{{ $user->nama ?? 'Admin' }}</span>
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ $user->nama ?? 'Admin' }}</span>
