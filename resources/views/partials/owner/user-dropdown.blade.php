...
<div class="relative" x-data="{
    ...
    >
        ...
        <span class="block mr-1 font-medium text-theme-sm">{{ $user->nama ?? 'Owner' }}</span>
    ...
    >
        <!-- User Info -->
        <div>
            <span class="block font-medium text-gray-700 text-theme-sm dark:text-gray-400">{{ $user->nama ?? 'Owner' }}</span>
