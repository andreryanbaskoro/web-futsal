...
@section('title', 'Booking Konfirmasi - Fustal ACT')
...
<section style="padding:120px 0 60px;background:var(--color-gray-100);min-height:100vh;">
    <div class="container">
        <div style="max-width:600px;margin:0 auto;">
            ...
            <div>
                <button onclick="payNow('{{ $pemesanan->kode_pemesanan }}')" id="btn-pay-now" class="btn btn-primary btn-lg w-full" style="margin-bottom: 12px;">
...
<script>
    // timestamp dari server (ISO 8601)
    ...
    function updateCountdown() {
        ...
        if (diff > 0) {
        ...
        } else if (!expiredShown) {
            expiredShown = true;

            // ❌ nonaktifkan tombol bayar (opsional tapi disarankan)
            ...
            Swal.fire({
                ...
                html: `
                    <p style="margin:0">
                        Batas waktu pembayaran telah berakhir.<br>
                        Pemesanan Anda otomatis dibatalkan.
                    </p>
                `,
